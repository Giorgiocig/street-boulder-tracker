...
export const getEvents = async (): Promise<any> => {
  const res = await fetch(`${apiUrl}/v1/events/get`);
...
export const getEventWithBouldersById = async (
  ...
  const res = await fetch(`${apiUrl}/v1/events/${eventId}/boulders`);
  const data = res.json();
  return data;
};
...
export const addEvent = async (data: any): Promise<any> => {
  const res = await fetch(`${apiUrl}/v1/events/add`, {
    method: "POST",
...
export const deleteEvent = async (id: number): Promise<any> => {
  const res = await fetch(`${apiUrl}/v1/events/${id}`, {
    method: "DELETE",
  });
  return res.json();
};
